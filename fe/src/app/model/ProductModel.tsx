...
productModel.isDiscount = productModelObject.isDiscount ?  productModelObject.isDiscount : false ; 
productModel.isSpecial = productModelObject.isSpecial ?  productModelObject.isSpecial : false ; 
