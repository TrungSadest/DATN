...
export default function BuyComponent() {
    ...
    // const { order } = location.state as { payload: OrderModel };
    // console.log(payload)
    return (
        <>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="custom-control custom-checkbox">
                                                ...
                                                <label className="custom-control-label" >Ship to different address</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="checkout-inner">
                                <div className="checkout-summary">
                                    ...
                                    <p className="sub-total">Sub Total<span>{ }</span></p>
                                    ...
                                    <div className="payment-methods">
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" >Payoneer</label>
                                            </div>
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" >Check Payment</label>
                                            </div>
                                        ...
                                        <div className="payment-method">
                                            <div className="custom-control custom-radio">
                                                ...
                                                <label className="custom-control-label" >Direct Bank Transfer</label>
                                            </div>
